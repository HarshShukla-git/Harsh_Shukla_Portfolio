...
const categories = [
  {
    icon: Settings,
    title: "Automation",
    skills: ["Selenium WebDriver", "UiPath Studio", "RPA Development", "Test Automation"],
  ...
  },
  {
    icon: Brain,
    title: "AI Tools",
    skills: ["OpenAI APIs", "Prompt Engineering", "LLM Integration", "AI Test Generation"],
    color: "from-primary/15 to-accent/15",
  },
  {
    icon: GitBranch,
    title: "DevOps",
    skills: ["Git & GitHub", "CI/CD Pipelines", "Jenkins Basics", "Docker Basics"],
    color: "from-accent/15 to-primary/15",
  },
  {
    icon: FlaskConical,
    title: "Testing",
    skills: ["API Testing", "Framework Design", "TestNG / JUnit", "Performance Testing"],
